from .evaluation import EvaluationView, DeleteEvaluation, EvaluationCreationView  # noqa
...
from .labelling import labellingView, labellingAgainView, labellingJustification, labellingEnd  # noqa
